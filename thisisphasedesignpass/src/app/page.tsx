...
const SUBSTACK_URL = 'https://momumentalreinvention.com';

// The two essays featured above the footer. Both point at the publication root
// until the individual post URLs are confirmed · swap in the /p/ slug per essay
// and nothing else has to change.
const ESSAYS = [
  { title: 'Two Chapters, One Body, One Year', href: SUBSTACK_URL },
  { title: 'Building Through It', href: SUBSTACK_URL },
];
  ...
  return (
    <>
      ...
      <div className="phase-home">
              ...
              <article className="room body" id="body">
                <div className="room-img">
                  <div className="tile pink" role="img" aria-label="The Body room">
                    <span className="rname">The Body</span>
                  </div>
                </div>
              ...
              <article className="room family" id="family">
                <div className="room-img">
                  <div className="tile navy" role="img" aria-label="The Family room">
                    <span className="rname">The Family</span>
                  </div>
                </div>
                <div className="room-head">
              ...
              <article className="room voice" id="voice">
                <div className="room-img">
                  <div className="tile pink" role="img" aria-label="The Voice room">
                    <span className="rname">The Voice</span>
                  </div>
                </div>
                <div className="room-head">
              ...
              <article className="room work" id="work">
                <div className="room-img">
                  <div className="tile navy" role="img" aria-label="The Work room">
                    <span className="rname">The Work</span>
                  </div>
                </div>
                <div className="room-head">
        ...
        {/* Essays · the letter the whole thing started as */}
        <section className="essays" id="letter">
          <div className="wrap">
            <span className="eyebrow">§ 06 · Read the letter</span>
            <h2>
            ...
            <div className="essay-list">
              {ESSAYS.map((e) => (
                ...
                >
                  ...
                  <span className="go">Read it →</span>
                </a>
              ))}
            </div>
