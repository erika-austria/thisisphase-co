...
* Trust signals: founder credentials, founder headshot, social proof placeholder, 3-step "what happens next".
*
* Founder headshot added Wed May 27 2026 · conversion trust signal · expected 15-25% lift.
*
...
{/* HERO · Founder trust signal · added Wed May 27 2026 */}
<div className="flex items-center gap-3 mt-8 pt-6 border-t border-navy/10">
<Image
src="/images/Erika%20Substack%20Avatar.PNG"
alt="Erika Hanafin Austria, founder of MOMumental Moments® and The PHASE™"
width={56}
height={56}
className="rounded-full border-2 border-pink/40 object-cover"
priority
/>
<div className="text-sm">
<p className="text-navy font-medium">Built by Erika Hanafin Austria</p>
<p className="text-navy/60 text-xs">Founder of The PHASE<sup>™</sup> · IIN-Certified Holistic Health Coach</p>
</div>
</div>
</div>
...
{/* Founder headshot · added Wed May 27 2026 · conversion trust signal */}
...
width={140}
height={140}
className="rounded-full border-4 border-pink/60 object-cover"
priority
/>
</div>
<p className="eyebrow eyebrow-pink text-xs mb-4 text-center">CREDENTIALS</p>
