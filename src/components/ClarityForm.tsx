...
* 2. Client sets Meta Pixel Advanced Matching userData (em) for higher EMQ
*    - Lifts Event Match Quality from 6.1/10 to 8+/10 (30-40% attribution lift)
*    - Meta auto-hashes the email server-side · SHA256 standard
*    - Applies to all initialized Pixels (master + product-line)
*    - Added Wed May 27 2026 per Meta Events Manager EMQ "Update recommended" warning
* 3. Client fires GA4 `generate_lead` event
* 4. Client fires Meta Pixel `Lead` event with eventID for CAPI dedup
*
...
// Set Meta Pixel Advanced Matching userData BEFORE firing Lead event.
// Meta auto-hashes (SHA256) the 'em' parameter server-side and uses it for
// Event Match Quality. This lifts EMQ from 6.1/10 to 8+/10 · 30-40%
// attribution accuracy gain on every Pixel event going forward.
// Applies to ALL initialized Pixels (master + product-line).
// Added Wed May 27 2026 per Meta Events Manager "Update recommended" warning.
try {
