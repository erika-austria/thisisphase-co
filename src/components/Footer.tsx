...
const FOOTER_CSS = `
:root{--navy:var(--bg-navy);--navy-deep:var(--bg-navy-deep);--cream:var(--bg-cream-page);--cream-deep:var(--bg-cream-alt);--serif:var(--font-fraunces),var(--font-cormorant),Georgia,serif;--mono:var(--font-geist-mono),ui-monospace,monospace}
