...
const FOOTER_CSS = `
:root{--navy:var(--bg-navy);--navy-deep:var(--bg-navy-deep);--cream:var(--bg-cream-page);--cream-deep:var(--bg-cream-alt);--serif:var(--font-instrument),var(--font-cormorant),Georgia,serif;--mono:var(--font-geist-mono),ui-monospace,monospace}
      ...
      <div className="wrap">
        <div className="foot-top">
          ...
          <div className="foot-links">
            ...
            <a href="/work">Work</a>
            <a href="https://www.momumentalreinvention.com/p/the-library" target="_blank" rel="noopener noreferrer">The PHASE™ Library</a>
